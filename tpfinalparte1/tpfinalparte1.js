...
image(imagen[1],0,0);
    ...
    cuadro(340, 420, 250, 50,"continuar...");
    ...
    image(imagen[2],0,0);
    cuadro(340, 420, 250, 50, "continuar...");
    cuadro(60, 420, 250, 50, "arrepentirse");
    rect(70, height/2, 510, 170);
    fill(255);
    textSize(20);
    ...
    image(imagen[3],0,0);
    cuadro(340, 420, 250, 50,"Adentrarse");
    cuadro(60, 420, 250, 50, "Pelear");
    rect(70, height/2, 510, 170);
    ...
    image(imagen[3],0,0);
    cuadro(340, 420, 250, 50,"Derecha");
    cuadro(60, 420, 250, 50,"Izquierda");
    rect(70, height/2, 510, 170);
   ...
   image(imagen[9],0,0);
    ...
    dialogo(50, 210, 'fb2b');
    dialogo(50, 240, 'fb2c');
    cuadro(160, 300, 300, 80,"Creditos");
    ...
    image(imagen[4],0,0);
    fill(352, 78, 40);
    cuadro(340, 420, 250, 50, "Avanzar en soledad");
    cuadro(60, 420, 250, 50, "Ser acomapañado");
    rect(70, height/2, 510, 170);
  ...
  if ( estado == "juego") {
    fill(352, 78, 40);
    cuadro(340, 420, 250, 50, "perder");
    cuadro(60, 420, 250, 50, "ganar");
    fill(255);
    textSize(20);
    noStroke();
